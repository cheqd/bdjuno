...
sed -i "s, RPC_ADDRESS, '${_self.RPC_ADDRESS}',g" ./.bdjuno/config.yaml
sed -i "s, GRPC_ADDRESS, '${_self.GRPC_ADDRESS}',g" ./.bdjuno/config.yaml
sed -i "s, LOG_LEVEL, '${_self.LOG_LEVEL}',g" ./.bdjuno/config.yaml
